...
![lsblk showing two disks](images/images-001_lsblk_discos.png)
...
![hostname and /etc/hosts configuration](images/images-002_hostname_y_etc_hosts.png)
...
![Netplan configuration file](images/images-003-Netplan_configuration_srv1.png)
...
![resolv.conf configuration](images/images-004-resolv_conf_srv1.png)
...
![Kerberos realm configuration during install](images/images-005-kerberos_reino.png)
...
![Domain provision output](images/images-006-Domain_Provision_srv1.png)
...
![smb.conf after provisioning](images/images-007-smb_conf_srv1.png)
...
![Kerberos verification and domain info](images/images-008_Kerberos_pruebas_srv1.png)
...
![User and group creation](images/images-009_creacion_usuarios.png)

![Users, groups and folder creation](images/images-009_creacion_usuarios_carpetas.png)
...
![smb.conf with all shares configured](images/images-010_smb_conf.png)
...
![Access verification per user — leia in blueprints, anakin denied, force permissions correct](images/images-014_comprobaciones_permisos_usuarios.png)
...
![Network configuration on uc01](images/images-015_Configuracion_Red_Cliente.png)
...
![resolv.conf on client](images/images-016_resolv_conf_client.png)
...
![Package installation on client](images/images-017_Instalacion_realmssd_Client.png)
...
![realm discover output](images/images-018_Realm_Discover.png)
...
![realm join and verification](images/images-019_Realm_Join.png)
...
![Kerberos tickets for domain users on client](images/images-020_Prueba_Usuario_Cliente.png)

### 7.8 Graphical Login with Domain User

Log out and log in as `leia@DEATHSTAR.LOCAL` with password `Admin_21`.

![leia logged in on uc01 via domain — whoami shows leia@deathstar.local](images/images-021_Prueba_Usuarios_Cliente_v2.png)
...
![VPC creation form](images/images-022_Creacion_VPC.png)

![VPC details and resource map](images/images-023_Verificacion_VPC.png)
...
![Auto-assign public IP enabled](images/images-024_Habilitar_IP_Automatica_VPC.png)
...
![Security group LAB07-SG with all rules](images/images-025_Grupos_De_Seguridad_Y_Reglas.png)
...
![SSH from Windows to EC2 instance — connected as ubuntu](images/images-026_ssh_desde_windows_a_ec2.png)
...
![hostname and /etc/hosts on bespin07](images/images-026_ssh_hostname_etc_hosts_bespin07.png)
...
![Domain provision on bespin07](images/images-027_Aprovisionamiento_bespin01.png)
...
![samba-ad-dc active and running on bespin07](images/images-029_UnMask_Status_bespin01.png)
...
![DNS check and Kerberos ticket on bespin07](images/images-028_Dns_Kinit_Bespin07.png)
...
![lando and boba created on bespin07](images/images-030_Creacion_Usuarios_bespin01.png)
...
![mkdir /city/trap/MPI and permissions](images/images-031_Creacion_Carpetas_bespin01.png)
...
![lando accesses trap, boba gets ACCESS DENIED](images/images-031_Creacion_Carpetas_Y_Comprobaciones_bespin01.png)
...
![sl train stopped with SIGSTOP — [1]+ Stopped sl visible](images/images-011_Sl_Stop.png)
...
![sl train resumed with SIGCONT](images/images-012_Sl_Continue.png)
...
![r2d2.sh script content](images/images-013_script_r2d2.png)
...
![crontab at 10:30, script execution and luke.sky file created](images/images-013_script.png)
...
![dns forwarder added to srv01 smb.conf](images/images-032_ParaElTrust_DnsForwarder_srv01.png)
...
![dns forwarder added to ls07 smb.conf](images/images-033_ParaElTrust_DnsForwarder_ls07.png)
...
![Trust creation with WERR_OK on both directions](images/images-034_Trust_Create.png)
...
![Trust list Direction[BOTH], validate WERR_OK, and cross-domain kinit to LAB07.LAN](images/images-035_Trust_Comprobaciones_srv01.png)
...
![ls07 shows deathstar.local in trust list — Direction[BOTH]](images/images-036_Trust_Comprobaciones_ls07.png)
